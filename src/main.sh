...
# Date: 07/28/18
# Description: Automatically install my system
# }}}
...
dialog --title "Welcome!" --msgbox "Let's continue to install the system!" 10 60
# }}}

# {{{ Username Dialog
name=$(dialog --no-cancel --inputbox "User account." 10 60 3>&1 1>&2 2>&3 3>&1)
...
# {{{ About to install dialog
dialog --title "Wooh! Install the system!" --msgbox "Now its time to install the system. Everything is automated. Sit back and relax." 13 60 || { clear; exit; }
